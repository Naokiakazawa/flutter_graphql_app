...
Serializer<GGetCommentsByPostIdReq> _$gGetCommentsByPostIdReqSerializer =
    new _$GGetCommentsByPostIdReqSerializer();
...
class _$GGetCommentsByPostIdReqSerializer
    implements StructuredSerializer<GGetCommentsByPostIdReq> {
  @override
  final Iterable<Type> types = const [
  ...
  @override
  final String wireName = 'GGetCommentsByPostIdReq';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, GGetCommentsByPostIdReq object,
      {FullType specifiedType = FullType.unspecified}) {
    final result = <Object?>[
      'vars',
      serializers.serialize(object.vars,
          specifiedType: const FullType(_i3.GGetCommentsByPostIdVars)),
      'operation',
      serializers.serialize(object.operation,
          specifiedType: const FullType(_i4.Operation)),
      'executeOnListen',
    ...
    if (value != null) {
      result
        ..add('optimisticResponse')
        ..add(serializers.serialize(value,
            specifiedType: const FullType(_i2.GGetCommentsByPostIdData)));
    }
    value = object.updateCacheHandlerKey;
    if (value != null) {
      result
  ...
  @override
  GGetCommentsByPostIdReq deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new GGetCommentsByPostIdReqBuilder();
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'vars':
          result.vars.replace(serializers.deserialize(value,
                  specifiedType: const FullType(_i3.GGetCommentsByPostIdVars))!
              as _i3.GGetCommentsByPostIdVars);
          break;
        case 'operation':
          result.operation = serializers.deserialize(value,
              specifiedType: const FullType(_i4.Operation))! as _i4.Operation;
        ...
        case 'optimisticResponse':
          result.optimisticResponse.replace(serializers.deserialize(value,
                  specifiedType: const FullType(_i2.GGetCommentsByPostIdData))!
              as _i2.GGetCommentsByPostIdData);
          break;
        case 'updateCacheHandlerKey':
          result.updateCacheHandlerKey = serializers.deserialize(value,
              specifiedType: const FullType(String)) as String?;
...
class _$GGetCommentsByPostIdReq extends GGetCommentsByPostIdReq {
  @override
  final _i3.GGetCommentsByPostIdVars vars;
  @override
  final _i4.Operation operation;
  @override
  final String? requestId;
  @override
  final _i2.GGetCommentsByPostIdData? Function(
          _i2.GGetCommentsByPostIdData?, _i2.GGetCommentsByPostIdData?)?
      updateResult;
  @override
  final _i2.GGetCommentsByPostIdData? optimisticResponse;
  @override
  final String? updateCacheHandlerKey;
  @override
  final Map<String, dynamic>? updateCacheHandlerContext;
  ...
  factory _$GGetCommentsByPostIdReq(
          [void Function(GGetCommentsByPostIdReqBuilder)? updates]) =>
      (new GGetCommentsByPostIdReqBuilder()..update(updates))._build();

  _$GGetCommentsByPostIdReq._(
      {required this.vars,
      required this.operation,
      this.requestId,
      this.updateResult,
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        vars, r'GGetCommentsByPostIdReq', 'vars');
    BuiltValueNullFieldError.checkNotNull(
        operation, r'GGetCommentsByPostIdReq', 'operation');
    BuiltValueNullFieldError.checkNotNull(
        executeOnListen, r'GGetCommentsByPostIdReq', 'executeOnListen');
  }

  @override
  GGetCommentsByPostIdReq rebuild(
          void Function(GGetCommentsByPostIdReqBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  GGetCommentsByPostIdReqBuilder toBuilder() =>
      new GGetCommentsByPostIdReqBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    final dynamic _$dynamicOther = other;
    return other is GGetCommentsByPostIdReq &&
        vars == other.vars &&
        operation == other.operation &&
        requestId == other.requestId &&
        updateResult == _$dynamicOther.updateResult &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GGetCommentsByPostIdReq')
          ..add('vars', vars)
          ..add('operation', operation)
          ..add('requestId', requestId)
          ..add('updateResult', updateResult)
...
class GGetCommentsByPostIdReqBuilder
    implements
        Builder<GGetCommentsByPostIdReq, GGetCommentsByPostIdReqBuilder> {
  _$GGetCommentsByPostIdReq? _$v;

  _i3.GGetCommentsByPostIdVarsBuilder? _vars;
  _i3.GGetCommentsByPostIdVarsBuilder get vars =>
      _$this._vars ??= new _i3.GGetCommentsByPostIdVarsBuilder();
  set vars(_i3.GGetCommentsByPostIdVarsBuilder? vars) => _$this._vars = vars;
  ...
  _i2.GGetCommentsByPostIdDataBuilder? _optimisticResponse;
  _i2.GGetCommentsByPostIdDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??= new _i2.GGetCommentsByPostIdDataBuilder();
  set optimisticResponse(
          _i2.GGetCommentsByPostIdDataBuilder? optimisticResponse) =>
      _$this._optimisticResponse = optimisticResponse;
  ...
  GGetCommentsByPostIdReqBuilder() {
    GGetCommentsByPostIdReq._initializeBuilder(this);
  }

  GGetCommentsByPostIdReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _vars = $v.vars.toBuilder();
      _operation = $v.operation;
  ...
  @override
  void replace(GGetCommentsByPostIdReq other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$GGetCommentsByPostIdReq;
  }

  @override
  void update(void Function(GGetCommentsByPostIdReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GGetCommentsByPostIdReq build() => _build();

  _$GGetCommentsByPostIdReq _build() {
    _$GGetCommentsByPostIdReq _$result;
    try {
      _$result = _$v ??
          new _$GGetCommentsByPostIdReq._(
              vars: vars.build(),
              operation: BuiltValueNullFieldError.checkNotNull(
                  operation, r'GGetCommentsByPostIdReq', 'operation'),
              requestId: requestId,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'GGetCommentsByPostIdReq', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
